...
const useScrollReveal = () => {
  ...
  return [ref, isVisible];
      ...
      {/* Threat map visualization has been removed */}
      <div className="py-12 text-center">
        <h3 className="text-xl font-semibold text-gray-300">Threat Intelligence Dashboard</h3>
        <p className="text-gray-500 mt-2">Real-time threat monitoring and analysis</p>
      </div>
