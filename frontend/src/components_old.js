      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid-12 gap-6">
          {teamMembers.map((member, index) => (
            <div 
              key={index} 
              className={`col-12 md:col-6 lg:col-4 cyber-card p-5 card-interactive-compact cursor-pointer animate-cyber-float transition-all duration-500 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
              style={{ 
                transitionDelay: `${index * 100}ms`,
              ...
              <div className="relative overflow-hidden rounded-xl mb-4 group">
                ...
                <div className="absolute top-3 right-3">
                  <div className="w-8 h-8 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-lg flex items-center justify-center animate-cyber-pulse">
                    <div className="w-2 h-2 bg-white rounded-full animate-neon-flicker"></div>
                  </div>
                </div>
                <div className="absolute bottom-3 left-3 right-3">
                  <div className="bg-black/50 backdrop-blur-sm rounded-lg p-2 border border-cyan-500/30">
                    <p className="text-cyan-400 font-medium text-xs">{member.experience}</p>
                  </div>
                </div>
              </div>
